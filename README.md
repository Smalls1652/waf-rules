...
| --- | --- |
| [`100` - GeoIP and IP range blocks](modsecurity/100_REQUEST_GEO_AND_IP_BLOCKS.conf) | Blocks certain geographical locations and IP ranges. IP address ranges are defined in [`modsecurity/blocked_ip_ranges.data`](modsecurity/blocked_ip_ranges.data) |
